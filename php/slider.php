        ...
        <section class="contenedor-swiper">
            ...
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="./images/slider/s1.webp" alt="hand with different types rings"></div>
                    <div class="swiper-slide"><img src="./images/slider/s2.webp" alt="vase with necklace called lotus necklace"></div>
                    <div class="swiper-slide"><img src="./images/slider/s3.webp" alt="model showing earrings called idril"></div>
                    <div class="swiper-slide"><img src="./images/slider/s4.webp" alt="hand holding orange leaves with different types of rings on the fingers"></div>
                    <div class="swiper-slide"><img src="./images/slider/s5.webp" alt="earring  called eara"></div>
                </div>
            </div>
